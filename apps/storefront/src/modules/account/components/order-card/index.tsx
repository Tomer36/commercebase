...
const OrderCard = ({ order }: OrderCardProps) => {
  ...
  return (
    <div className="bg-white flex flex-col" data-testid="order-card">
      ...
      <div className="flex items-center divide-x rtl:divide-x-reverse divide-gray-200 text-small-regular text-black">
        ...
        {order.items?.slice(0, 3).map((i) => {
          return (
            ...
            >
              ...
              <div className="flex items-center text-small-regular text-black">
                <span
