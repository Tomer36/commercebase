...
import { ArrowPath as Refresh, ArrowUturnLeft as Back } from "@medusajs/icons"
      ...
      <div className="grid grid-cols-1 gap-y-8">
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">{t("simpleExchangesBody")}</p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          <Back />
          <div>
            ...
            <p className="max-w-sm">{t("easyReturnsBody")}</p>
          </div>
        </div>
      </div>
    </div>
