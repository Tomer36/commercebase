                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 transition-colors duration-150 active:scale-[0.99] hover:border-gray-300",
                        {
